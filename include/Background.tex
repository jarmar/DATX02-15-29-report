...
\todo{PLEASE COMMENT ON NEW FIGURE, IS ADDED "source code" AND "runnable code" A GOOD ADDITION?}
\todo{remove old pdf if new one is ok}

% To make it more general, we could change "type checker" to somthing like "semantic analysis". Then we include other things you do to code to make sure it's correct.
