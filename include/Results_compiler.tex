...
\todo{It's slightly weird to have this in the middle of the results part, since the compiler is the main result. It should go first or last (I think first).}

\todo{Maybe the main usage should be mentioned, i.e. that the compiler takes a top-level module as argument and compiles it and all its dependencies?}
