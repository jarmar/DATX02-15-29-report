...
%% Conclusion from: Results / Discussion

%% Relate to problem statement/purpose

%% We have not shown that it is possible to create the desired amalgamation. But we have not shown that it is not possible either. We have too little interaction with Erlang to make it a proper joining of the two areas of interest.
...
\todo{potential future here or in discussion}