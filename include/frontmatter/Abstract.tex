...
\todo{current abstract doesn't have a good flow, mostly summarizes the chapters, focus less on chapters and more on actual content}
...
The resulting Hopper language is a clean basic functional programming language with indentation sensitive syntax featuring polymorphic \glspl{adt}, pattern matching and lambdas. The compiler also has a module system and some integration with Erlang. \todo{stolen from results, rephrase?}
...
\todo{Describe why it is interesting}
